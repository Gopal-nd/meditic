  ...
  return(
    <div className='container mx-auto flex flex-col w-full justify-center space-y-6 sm:w-[400px]'>
        <div className='flex flex-col space-y-2 text-center'>
            ...
            <h1 className='text-2xl font-semibold tracking-tight'>Welcome to Meditic</h1>
            ...
            <p className="px-8 text-center text-sm text-zinc-700" >
                Do you have Account in Meditic ?{' '}
                <Link href={'/sign-in'} className="hover:text-zinc-900 text-sm hover:underline-offset-4 hover:underline">
                Sign In</Link>
            </p>
        </div>
    </div>
